...
export function PaymentMethod() {
  return (
    <div className="flex flex-col bg-[#f5f5f5] items-center justify-center min-h-screen gap-4">
      <div className="bg-white max-w-[400px] w-full p-8 rounded-2xl border border-black/20 shadow-sm">
        ...
        <div className="flex flex-col gap-3">
          ...
          >
            <Icon icon="simple-icons:pix" width={24} className="text-green-500" />
            <span>Pix</span>
          </Link>

          <button className="flex items-center gap-3 px-4 py-3 border rounded-md bg-white hover:bg-gray-100">
            <Icon icon="mdi:credit-card-outline" width={24} className="text-black" />
            <span>Cartão</span>
          </button>
