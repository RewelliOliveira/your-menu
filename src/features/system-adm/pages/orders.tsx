...
export function Orders() {
  ...
  const orders: Order[] = [
    ...
    { id: 2, customer: "Mariana Silva", item: "Hambúrguer Clássico", address: "Rua das Flores, 123 – Jardim", price: 15.5, status: "Entregue" },
    { id: 3, customer: "João Pereira", item: "Sushi Combo 20 peças", address: "Av. Brasil, 456 – Centro", price: 45.0, status: "Em entrega" },
    { id: 4, customer: "Carla Souza", item: "Lasanha à Bolonhesa", address: "Rua do Comércio, 78 – Vila Rica", price: 32.5, status: "Entregue" },
    ...
    { id: 7, customer: "Lucas Fernandes", item: "Pizza Calabresa", address: "Av. Paulista, 1000 – Bela Vista", price: 38.5, status: "Entregue" },
    ...
    { id: 10, customer: "Ana Paula", item: "Frango Grelhado com Arroz", address: "Rua do Lago, 34 – Vila Nova", price: 25.0, status: "Em preparo" },
    { id: 11, customer: "Marcos Oliveira", item: "Bife Acebolado", address: "Rua das Rosas, 90 – Centro", price: 30.0, status: "Em preparo" },
    ...
    { id: 15, customer: "Gabriel Souza", item: "Hambúrguer com Bacon", address: "Rua das Orquídeas, 10 – Jardim", price: 20.0, status: "Em preparo" },
    ...
    { id: 20, customer: "Larissa Gomes", item: "Pizza Quatro Queijos", address: "Rua das Flores, 77 – Jardim", price: 38.0, status: "Em preparo" },
  ];

  function handleVerMais() { //tem que fazer ainda
    alert("sei la");
  }
